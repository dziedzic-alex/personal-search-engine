    ...
    assert response.json() == [
        {
            ...
            "status": "processed",
            "numAttempts": 0,
            "contentUrl": "https://presigned.example/1/piia.pdf",
        ...
        },
        {
            ...
            "status": "processed",
            "numAttempts": 0,
            "contentUrl": "https://presigned.example/1/exit.pdf",
    ...
    assert response.json() == [
        {
            ...
            "status": "processed",
            "numAttempts": 0,
            "contentUrl": "https://presigned.example/1/photo.jpg",
        ...
        },
        {
            ...
            "status": "processed",
            "numAttempts": 0,
            "contentUrl": "https://presigned.example/1/scan.png",
