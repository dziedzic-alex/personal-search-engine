...
def mock_embedding_models(mocker):
    ...
    mocker.patch("workers.image.image.get_text_embedding_model", return_value=text_model)
    mocker.patch("workers.image.image.get_image_embedding_model", return_value=image_model)
